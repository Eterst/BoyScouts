        ...
        foreach ($vars['listado'] as $item) {
            ...
            <tr>
                ...
                <td>  <a  class="btn btn-warning" href='?controlador=Item&accion=modificarVistaMiembro&id=<?php echo $item[0] ?>'> 
                    ...
                    <a  class="btn btn-danger" href='?controlador=Item&accion=metodoEliminarMiembroGrupo&id=<?php echo $item[0] ?>&idgrupo=<?php echo $vars['idgrupo'] ?>'> 
                        <img src="public/img/eliminar.svg"  width="20" height="20"> </img>
                    </a>
                </td>
            </tr>
            <?php
