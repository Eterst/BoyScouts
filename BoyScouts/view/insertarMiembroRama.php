...
<form action="?controlador=Item&accion=insertarGrupo" method="post">
    <center> 
        <label   style="color: #000000; font-size: 20px;">Registrar Rama </label> 
    </center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tipo" name="tipo" readonly="" placeholder="Rama" value="<?php echo "rama" ?>">
                            </div>
                            <div2 class="form-group">
                                <label>
                                    Cedula Jefe
