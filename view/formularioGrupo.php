                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div2 class="form-group">
                                ...
                                <select type="number" class="form-control" id="idrama" name="idrama">
                                    <?php
                                    foreach ($vars['ramas'] as $item) {
                                        ?>
                                        <option value=<?php echo $item[0]?> > <?php echo $item[2] ?> </option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                -->
                                <input type="hidden" class="form-control" id="tipo" name="tipo" readonly="" placeholder="Grupo" value="<?php echo "grupo" ?>">
                            </div>
                            <div2 class="form-group">
                                <label>
                                    Cedula Monitor
                                </label>
                                <select type="number" class="form-control" id="cedulamonitor"  name="cedulamonitor">
                                    <?php
                                    foreach ($vars['miembros'] as $item) {
                                        ?>
